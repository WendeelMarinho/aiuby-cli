...
Kısa ve uzun kılavuzlarda ele alınan her şey GitHub'da mevcuttur: `github.com/WendeelMarinho/aiuby-cli`
...
*Oturum depolama örneği -> <https://github.com/WendeelMarinho/aiuby-cli/tree/main/examples/sessions>*
...
Bu hook'ları oluşturdum ve repo'da `github.com/WendeelMarinho/aiuby-cli/tree/main/hooks/memory-persistence` adresindeler
...
Bunu yapan bir sürekli öğrenme skill'i oluşturdum: `github.com/WendeelMarinho/aiuby-cli/tree/main/skills/continuous-learning`
...
*Her iki kılavuzda ele alınan her şey GitHub'da [everything-claude-code](https://github.com/WendeelMarinho/aiuby-cli) adresinde mevcuttur*
