...
- `aiuby migrate audit --source ~/.hermes`
- `aiuby migrate plan --source ~/.hermes --output migration-plan.md`
- `aiuby migrate scaffold --source ~/.hermes --output-dir migration-artifacts`
- `aiuby migrate import-skills --source ~/.hermes --output-dir migration-artifacts/skills`
- `aiuby migrate import-tools --source ~/.hermes --output-dir migration-artifacts/tools`
- `aiuby migrate import-plugins --source ~/.hermes --output-dir migration-artifacts/plugins`
- `aiuby migrate import-schedules --source ~/.hermes --dry-run`
- `aiuby migrate import-remote --source ~/.hermes --dry-run`
- `aiuby migrate import-env --source ~/.hermes --dry-run`
- `aiuby migrate import-memory --source ~/.hermes`
