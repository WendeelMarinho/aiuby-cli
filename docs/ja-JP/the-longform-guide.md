...
簡潔ガイドと長文ガイドで取り上げたすべてのものはGitHubで利用可能です：`github.com/WendeelMarinho/aiuby-cli`
...
*セッションストレージの例 -> <https://github.com/WendeelMarinho/aiuby-cli/tree/main/examples/sessions>*
...
これらのフックを構築し、リポジトリの`github.com/WendeelMarinho/aiuby-cli/tree/main/hooks/memory-persistence`に置いています。
...
この機能を実現する継続学習スキルを構築しました：`github.com/WendeelMarinho/aiuby-cli/tree/main/skills/continuous-learning`
...
*両ガイドで取り上げたすべてのものはGitHubの[everything-claude-code](https://github.com/WendeelMarinho/aiuby-cli)で利用可能です*
