const REPOSITORY_ISSUES_URL = 'https://github.com/WendeelMarinho/aiuby-cli/issues/new';
...
function problemReportLines() {
  return [
    ...
    'Aiuby does not upload diagnostics. Redact paths, repository names, prompts, and secrets before sharing output.',
  ];
}
...
function exitFeedbackLines() {
  return [
    ...
    'Aiuby does not upload diagnostics or block uninstall.',
  ];
}
