 ...
 *
 * @see https://github.com/WendeelMarinho/aiuby-cli/issues/2065
 */
...
function ensureAgentDataHomeEnv(options = {}) {
  ...
  if (!expandHomePath(getEnv(AGENT_DATA_HOME_ENV))) {
    applyEnv(AGENT_DATA_HOME_ENV, resolved); // aiuby:compat
  }
  return resolved;
}
