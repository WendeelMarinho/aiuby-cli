<p align="center">
  <img src="assets/hero.png" alt="Aiuby AI Engineering — AI-native engineering system" width="100%" />
</p>
...
- [ ] Replace `assets/hero.png` with the official Aiuby AI Engineering hero image.
- [ ] Confirm the final GitHub repository URL.
- [ ] Create or confirm `docs/pt-BR/README.md`.
- [ ] Replace package names and npm links.
- [ ] Replace Claude Code marketplace and plugin identifiers.
- [ ] Rename CLI commands from `ecc` to `aiuby` with backward compatibility.
...
- [ ] Preserve required MIT license and original copyright notices.
